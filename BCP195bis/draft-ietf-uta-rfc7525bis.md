...
[^live-ref-question]: RFC Editor: We are looking for advice on how to best handle this constantly updated guidance.  In particular: which URL to use, which (if any) version to reference
