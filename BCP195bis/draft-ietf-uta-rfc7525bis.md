...
* Certificate revocation is an important tool in the face of recovering from attacks on the TLS implementation, as well as the problem of misissued certificates. TLS implementations MUST implement a strategy to distrust revoked certificates.
